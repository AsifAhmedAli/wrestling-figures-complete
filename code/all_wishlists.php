      ...
      <section class="collections">
        ...
        <div class="body">
          <div class="container-fluid">
            <div class="top">
              <h4 class="title">All Wishlists</h4>
              <div class="filters">
                      ...
                      <div class="modal-body">
                        <form id="new_collection">
                          <div class="mb-3">
                            ...
                            <input name="wishlist_name" style="color: black;" type="text" class="form-control" id="exampleInputEmail1"
            ...
            <div class="modal fade"  style="color: black;" id="exampleModal1" tabindex="-1" aria-labelledby="exampleModalLabel1"
                  ...
                  <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel1">Edit Wishlist</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                      </div>
                      <div class="modal-body">
                        <form id="edit_wishlist">
                          <div class="mb-3">
                            ...
                            <input id="collectionsaas" name="id_of_wishlist" style="visibility: hidden;">
                          </div>
                          <button type="submit" class="btn btn-primary">Save</button>
                        </form>
                      </div>
            ...
            <div class="list-collection table-responsive rounded bg-darkblue py-3 px-1">
              <table class="table">
                ...
                <tbody>
                  <?php
                  $conn->next_result();
                    $sql21 = "CALL all_wishlists('$loggedinuserid')";
                    $result21 = $conn->query($sql21);
                    if ($result21->num_rows > 0) {
                    // output data of each row
                    while($row21 = $result21->fetch_assoc()) {
                      $id_of_wishlist = $row21['id'];
                      // echo "<script>console.log('$id_of_collection')</script>";
                      // $result->close();
                      $conn->next_result();
                                    $sql212 = "CALL count_wrestling_figures_in_a_wishlist('$id_of_wishlist')";
                      ...
                      ?>
                      <tr>
                        <td><a href="./singlewishlist.php?wishlist_id=<?php echo $id_of_wishlist; ?>&name=<?php echo $row21['name1']; ?>"><?php echo $row21['name1']; ?></a></td>
                        <td><?php echo $row21['created_on']; ?></td>
                        <td><?php echo $number_of_figures; ?></td>
                        <td><span role="button" onclick="deletewishlist('<?php echo $id_of_wishlist; ?>')" class="hover-border material-icons material-icons-outlined">delete</span></td>
                        <td>
                          <span role="button" onclick="edit_wislist_modal('<?php echo $id_of_wishlist; ?>', '<?php echo $row21['name1']; ?>')" class="p-2 hover-border">Edit</span> 
                        </td>
                      </tr>                      
                      <?php
                    }
  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.min.js"
    ...
    $("#new_collection").submit(function (event) {
      ...
      $.ajax({
        type: "post",
        data: serializedData,
        url: "controllers/new_wishlist_controller.php",
    ...
    function edit_wislist_modal(x, nameofwishlist){
      $('#exampleModal1').modal('show');
      document.getElementById("collectionsaas").value = x;
      document.getElementById("edit_wishlist_name").value = nameofwishlist;
      // alert(x);
      // document.getElementById("loader1").style.visibility = "visible";
      // $.ajax({
      //   type: "post",
    ...
    $("#edit_wishlist").submit(function (event) {
        ...
        $.ajax({
          type: "post",
          data: serializedData,
          url: "controllers/edit_wishlist_controller.php",
          success: function (result) {
            $("#div11").html(result);
            document.getElementById("loader1").style.visibility = "hidden";
          }
