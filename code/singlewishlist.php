              ...
              <div class="top">
                ...
                <div class="filters">
                  <div class="dropdown me-lg-4 me-3">
                    ...
                    >
                      <li>
                        <a class="dropdown-item active" href="./singlewishlist.php?wishlist_id=<?php echo $wishlist_id; ?>&name=<?php echo $name; ?>&filter=brand">Brand</a>
                      </li>
                      <li>
                        <a class="dropdown-item" href="./singlewishlist.php?wishlist_id=<?php echo $wishlist_id; ?>&name=<?php echo $name; ?>&filter=series">Series</a>
                      </li>
                      <li>
                        <a class="dropdown-item" href="./singlewishlist.php?wishlist_id=<?php echo $wishlist_id; ?>&name=<?php echo $name; ?>&filter=year">Year</a>
                      </li>
                    </ul>
                  </div>
                  <div class="dropdown">
