              ...
              <div class="top">
                ...
                <div class="filters">
                  <div class="dropdown me-lg-4 me-3">
                    ...
                    >
                      <li>
                        <a class="dropdown-item active" href="./singlecollection.php?col=<?php echo $col_id; ?>&name=<?php echo $col_name; ?>&filter=brand">Brand</a>
                      </li>
                      <li>
                        <a class="dropdown-item" href="./singlecollection.php?col=<?php echo $col_id; ?>&name=<?php echo $col_name; ?>&filter=series">Series</a>
                      </li>
                      <li>
                        <a class="dropdown-item" href="./singlecollection.php?col=<?php echo $col_id; ?>&name=<?php echo $col_name; ?>&filter=year">Year</a>
                      </li>
                    </ul>
                  </div>
                  <div class="dropdown">
